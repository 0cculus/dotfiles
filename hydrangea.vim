...
hi Normal ctermfg=251 ctermbg=234 guifg=#c6c6c6 guibg=#1b202a
...
hi Visual ctermfg=NONE ctermbg=180 cterm=NONE guifg=NONE guibg=#303540 gui=NONE
...
hi Comment ctermfg=Cyan cterm=NONE guifg=#00ffff gui=NONE
hi Constant ctermfg=99 ctermbg=NONE cterm=NONE guifg=#0990b5 guibg=NONE gui=NONE
hi String ctermfg=32 ctermbg=235 cterm=NONE guifg=#0487d8 guibg=#002844 gui=NONE
hi Number ctermfg=163 ctermbg=236 cterm=NONE guifg=#0990b5 guibg=#023342 gui=NONE
...
hi Structure ctermfg=168 cterm=NONE guifg=#b966af gui=NONE
